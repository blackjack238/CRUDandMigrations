...
VALUES
  ('John Doe', '1990-05-10', 'Trainee', 830),
  ('Jane Smith', '1985-08-15', 'Junior', 1207),
  ('Mark Johnson', '1982-03-20', 'Middle', 3300),
  ('Emily Williams', '1978-12-05', 'Senior', 7050),
  ('Michael Brown', '1992-06-25', 'Junior', 1550),
  ('Sarah Davis', '1991-09-30', 'Middle', 4000),
  ('Robert Taylor', '1989-02-12', 'Senior', 9010),
  ('Jennifer Anderson', '1987-07-18', 'Trainee', 900),
  ('David Wilson', '1984-11-23', 'Middle', 3500),
  ('Jessica Martinez', '1980-04-07', 'Junior', 1810);
